//1. Crear la clase persona con dos objetos, solicitando la información al usuario
...
public class Ejercicio01 {
    ...
    public static void main(String[] args) {
        ...
        persona3.nombre = JOptionPane.showInputDialog("Ingrese Nombre de la Persona 3");
        persona3.edad = Integer.parseInt(JOptionPane.showInputDialog("Ingrese la Edad de la Persona 3"));
        persona3.saludar();
